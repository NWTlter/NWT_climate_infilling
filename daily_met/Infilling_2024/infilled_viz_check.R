...
################################################################################
#temp
c1_chart_infilled <- read.csv(file.path(infill_path, "c1_chart_infilled_v1.csv")) |>
  dplyr::mutate(date = lubridate::date(date))

d1_chart_infilled <- read.csv(file.path(infill_path, "d1_chart_infilled_v1.csv")) |>
  dplyr::mutate(date = lubridate::date(date))

alldats <- read.csv(file.path(infill_path, "alldats.csv"))
...
for (col in c("precip")){
  ...
  # ggsave(paste0(plot_out, col, "_c1_ppt_infilled_allyrs.png"), plot = p, device = 'png', height = 6, width=8)
  ...
  for (y in c(2024)){
    ...
    ggsave(paste0(plot_out, col, "_c1_ppt_infilled_",y,".png"), plot = p, device = 'png', height = 6, width=8)
    ...
    for (mon in 1:12){
      ...
      ggsave(paste0(plot_out, col, "_c1_ppt_infilled_",y,mon,".png"), plot = p, device = 'png', height = 6, width=8)
    }
...
for (col in c("precip")){
  ...
  for (y in c(2024)){
    ...
    ggsave(paste0(plot_out, col, "_d1_ppt_infilled_",y,".png"), plot = p, device = 'png', height = 6, width=8)
    ...
    for (mon in 1:12){
      ...
      ggsave(paste0(plot_out, col, "_d1_ppt_infilled_",y,mon,".png"), plot = p, device = 'png', height = 6, width=8)
    }
...
for (rep in 1:3){
  ...
  for (metric in c("airtemp_max", "airtemp_min", "airtemp_avg")){
    ...
    for (y in c(2023, 2024)){
      ...
      ggsave(paste0(plot_out, col, "_sdl_infilled_",y,".png"), plot = p, device = 'png', height = 6, width=8)
...
for (col in c("precip")){
  ...
  for (y in c(2024)){
    ...
    ggsave(paste0(plot_out, col, "_sdl_ppt_infilled_",y,".png"), plot = p, device = 'png', height = 6, width=8)
    ...
    for (mon in 1:12){
      ...
      ggsave(paste0(plot_out, col, "_sdl_ppt_infilled_",y,mon,".png"), plot = p, device = 'png', height = 6, width=8)
    }
