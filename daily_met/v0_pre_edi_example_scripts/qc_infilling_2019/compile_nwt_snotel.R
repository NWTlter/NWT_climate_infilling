...
tmin <- read_csv("https://wcc.sc.egov.usda.gov/reportGenerator/view_csv/customSingleStationReport/daily/663:CO:SNTL|id=%22%22|name/POR_BEGIN,POR_END/TMIN::value", skip = 52)
tmax <- read_csv("https://wcc.sc.egov.usda.gov/reportGenerator/view_csv/customSingleStationReport/daily/663:CO:SNTL|id=%22%22|name/POR_BEGIN,POR_END/TMAX::value", skip = 52)
...
# -- FINISHING -----
# write out
write_csv(snotel_temp, "climate_d1_c1/output_data/prep_data/nwt_snotel_temp.csv")
write_csv(snotel_ppt, "climate_d1_c1/output_data/prep_data/nwt_snotel_ppt.csv")
write_csv(uc_ppt2, "climate_d1_c1/output_data/prep_data/nwt_univcamp_ppt.csv")
